...
Write-Host "Downloading PostgreSQL binaries fast with curl..."
curl.exe -L -o postgres.zip "https://get.enterprisedb.com/postgresql/postgresql-15.8-1-windows-x64-binaries.zip"
